...
export class StubLLM implements LLM {
  ...
  private igCard(req: LLMRequest): unknown {
    ...
    return {
      cards: [
        `${topic}`, // headline
        "추상적인 '열심히'는 멈춤을 불러요",
        "할 일을 '지금 할 첫 한 가지'로 쪼개보세요",
        "5분이면 끝나는 행동부터 손에 잡아요",
        "끊겨도 '복귀 기준' 한 줄이 다시 시작하게 해요",
        "오늘의 첫 행동을 댓글에 적어보세요 →", // cta
      ],
      caption: `${topic}\n\n흐릿한 목표는 시작을 막아요. 지금 할 첫 한 가지로 쪼개보세요.\n\n※ 의학적 조언이 아닙니다. 진단·치료는 전문가와 상담하세요.\n#ADHD #성인ADHD #실행기능 #ADHD플래너`,
  ...
  private thread(req: LLMRequest): unknown {
    ...
    const byTone: Record<ThreadTone, string> = {
      serious: "흐릿한 목표는 멈춤을 불러요. 오늘은 '지금 할 첫 한 가지'만 정해봐요. 책상 위 컵 하나를 싱크대에 두는 것부터요.",
      casual_promo: "플래너 만들면서 겪은 거예요. 기능을 더 넣을수록 제가 안 쓰더라고요. 그래서 '다음 한 가지'만 보이게 갈아엎었어요.",
      question: "할 일 목록을 보면 어디서부터 막히세요? 저는 '제일 쉬운 것'에서 자꾸 멈춰요. 여러분은 어디서 멈추세요?",
      empathy_short: "방금 뭐 하려 했더라, 하고 멈춘 다섯 번째. 그래도 괜찮아요. 지금 한 가지만 해요.",
    };
